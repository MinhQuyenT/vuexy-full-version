<template>
  ...
  <div style="height: inherit">
    ...
    <div class="email-app-list">
      ...
      <div class="app-action">
        ...
        <div v-show="selectedEmails.length" class="align-items-center" :class="{ 'd-flex': selectedEmails.length }">
          ...
          <feather-icon icon="MailIcon" size="17" class="cursor-pointer ml-1" @click="markSelectedEmailsAsUnread" />

          <feather-icon v-show="$route.params.folder !== 'trash'" icon="TrashIcon" size="17" class="cursor-pointer ml-1"
      ...
      <vue-perfect-scrollbar :settings="perfectScrollbarSettings" class="email-user-list scroll-area">
        <ul class="email-media-list">
          <b-media v-for="email in emails" :key="email.id" tag="li" no-body :class="{ 'mail-read': email.isRead }"
            ...
            <b-media-aside class="media-left mr-50">
              ...
              <div class="user-action">
                ...
                <div class="email-favorite">
                  <feather-icon icon="StarIcon" size="17" :class="{ 'text-warning fill-current': email.isStarred }"
            ...
            <b-media-body>
              <div class="mail-details">
                ...
                <div class="mail-meta-item">
                  ...
                  <span v-for="label in email.labels" :key="label" class="mx-50 bullet bullet-sm"
                    :class="`bullet-${resolveLabelColor(label)}`" />
                  <span class="mail-date">{{ formatDateToMonthShort(email.time, { hour: 'numeric', minute: 'numeric', })
                  }}</span>
                </div>
              </div>
    ...
    <portal to="content-renderer-sidebar-left">
      <email-left-sidebar :shall-show-email-compose-modal.sync="shallShowEmailComposeModal" :emails-meta="emailsMeta"
